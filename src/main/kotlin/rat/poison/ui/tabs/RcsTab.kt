...
class RcsTab : Tab(false, false) {
    ...
    val rCrosshairRadius = VisSliderCustom("RCrosshair Radius", "RCROSSHAIR_RADIUS", 1F, 50F, 1F, true, labelWidth = 200F, barWidth = 250F)
    ...
    val rCrosshairAlpha = VisSliderCustom("RCrosshair Alpha", "RCROSSHAIR_ALPHA", .1F, 1F, .1F, false, labelWidth = 200F, barWidth = 250F)
